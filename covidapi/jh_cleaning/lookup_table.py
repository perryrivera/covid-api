...
if __name__ == '__main__':
    matcher = Matcher()
    print(matcher.match_combined_key('Antigua and Barbuda'))
    print(matcher.match_region(RegionNames(country_region='United Kingdom', province_state=None, admin2=None)))
    print(matcher.lookup_by_id(15613))
